...
{
    public class Basketbol2122SezonNbaWestController : Controller
    {
        private readonly siCoreContext _context;

        public Basketbol2122SezonNbaWestController(siCoreContext context)
        {
            _context = context;
        }

        // GET: Basketbol2122SezonNbaWest
        public async Task<IActionResult> Index()
        {
            var siCoreContext = _context.Basketbol2122SezonNbaWest.Include(f => f.Takim).OrderByDescending(f => f.TakimGalibiyet);
            return View(await siCoreContext.ToListAsync());
        }

        // GET: Basketbol2122SezonNbaWest/Details/5
        ...
        // GET: Basketbol2122SezonNbaWest/Create
        ...
        // POST: Basketbol2122SezonNbaWest/Create
        ...
        // GET: Basketbol2122SezonNbaWest/Edit/5
        ...
        // POST: Basketbol2122SezonNbaWest/Edit/5
        // To protect from overposting attacks, enable the specific properties you want to bind to, for 
        // more details, see http://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        ...
        // GET: Basketbol2122SezonNbaWest/Delete/5
        ...
        // POST: Basketbol2122SezonNbaWest/Delete/5
