...
{
    public class Basketbol1920SezonTr1Controller : Controller
    {
        private readonly siCoreContext _context;

        public Basketbol1920SezonTr1Controller(siCoreContext context)
        {
            _context = context;
        }

        // GET: Basketbol1920SezonTr1
        public async Task<IActionResult> Index()
        {
            var siCoreContext = _context.Basketbol1920SezonTr.Include(b => b.Takim);
            return View(await siCoreContext.ToListAsync());
        }

        // GET: Basketbol1920SezonTr1/Details/5
        ...
        // GET: Basketbol1920SezonTr1/Create
        ...
        // POST: Basketbol1920SezonTr1/Create
        ...
        // GET: Basketbol1920SezonTr1/Edit/5
        ...
        // POST: Basketbol1920SezonTr1/Edit/5
        // To protect from overposting attacks, enable the specific properties you want to bind to, for 
        // more details, see http://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        ...
        // GET: Basketbol1920SezonTr1/Delete/5
        ...
        // POST: Basketbol1920SezonTr1/Delete/5
