...
{
    public class Basketbol2122SezonNbaEast1Controller : Controller
    {
        private readonly siCoreContext _context;

        public Basketbol2122SezonNbaEast1Controller(siCoreContext context)
        {
            _context = context;
        }

        // GET: Basketbol2122SezonNbaEast1
        public async Task<IActionResult> Index()
        {
            var siCoreContext = _context.Basketbol2122SezonNbaEast.Include(b => b.Takim);
            return View(await siCoreContext.ToListAsync());
        }

        // GET: Basketbol2122SezonNbaEast1/Details/5
        ...
        // GET: Basketbol2122SezonNbaEast1/Create
        ...
        // POST: Basketbol2122SezonNbaEast1/Create
        ...
        // GET: Basketbol2122SezonNbaEast1/Edit/5
        ...
        // POST: Basketbol2122SezonNbaEast1/Edit/5
        // To protect from overposting attacks, enable the specific properties you want to bind to, for 
        // more details, see http://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        ...
        // GET: Basketbol2122SezonNbaEast1/Delete/5
        ...
        // POST: Basketbol2122SezonNbaEast1/Delete/5
